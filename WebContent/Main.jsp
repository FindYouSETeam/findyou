...
<div id="showdiv"
    ...
    <!-- 标题 -->
    <div style="background: #F8F7F7; width: 100%; height: 2rem; font-size: 1.3rem; line-height: 2rem; border: 1px solid #999; text-align: center;">
        提示
    </div>
    <!-- 内容 -->
    <div style="text-indent: 100px; height: 4rem; font-size: 1rem; padding: 1rem; line-height: 2rem; ">
        <table>
            <tr>
                <td>ss</td>
                <td>ss</td>
    ...
    <!-- 按钮 -->
    <div style="background: #418BCA; width: 50%; margin: 0 auto; height: 2rem; line-height: 1.5rem; text-align: center;color: #fff;margin-top: 11rem; -moz-border-radius: .128rem; -webkit-border-radius: .128rem; border-radius: .128rem;font-size: 1.0rem;"
         onclick="closeWindow()">
        确 定
    </div>
</div>
...
<div id="showdiv_login"
    ...
    <!-- 内容 -->   
        <div style="height: 40px; font-size: 20px; padding: 10px; line-height: 20px;text-align: center; ">
        		...
        		<s:form action ="login" method="post">
	              <table >
	                ...
	                <tr>
						...
						<td><input name="type" type="radio" value="admin" />管理</td>
	                </tr>
	                <tr>
						<td>
...
<div id="主体1"
    ...
    <div class="rightp" id="rightp">
        <a href="javascript:void(0);" onclick="logind()">登陆</a> |
        <a href="RegisterUser.jsp">注册</a>
    </div>
    <div class="word" id="word" align="center">
        还在苦恼于拉不到外联吗？<br/>
        还在苦恼于没有地方赞助吗？<br/>
        <h2>找到你 就是解决你问题的地方！</h2><br/>
    </div>
    <div class="button" align="center" style="color: #b0d6d4" align="center"><a class="buttondown" id="buttondown"
                                                                                href="javascript:void(0);"><h2>了解更多</h2>
    </a></div>
    <!--<div class="button" align="center"><a id="button" onclick="showWindow();">点击弹窗</a></div>-->
</div>

<div id="主体2" style="margin-top: 0%;margin-bottom: 0;padding-top: 0px;height: 500px;background-color: #eee;"
     align="center">
    功能介绍1
    <h2>还在用收到请回复？</h2>
    <h3>接收方无需回复“已收到”<br/>发送方可实时跟进通知进度</h3>
    <ul class="mobile">
        <img class="setting-picture sr-picture" src="image/test.png" width="10%" alt="666"/>
        <img class="setting-picture sr-picture" src="image/test.png" width="10%" alt="666"/>
    </ul>
</div>
<div id="主体3" style="margin-top: 0%;margin-bottom: 0;padding-top: 0px;height: 500px;background-color: #FFFFFF;"
     align="center">

    <h2>回复详情实时查看</h2>
    <h3>实时查看回复详情<br/>一键Excel导出，告别手动整理</h3>
    <img src="image/test.png" width="15%" class="setting-picture sr-create-org" alt="创建组织">
    功能介绍2
</div>
        ...
        <div class="container setting-center">
            ...
            <div class="moreContentFlexBox">
                <div class="moreContentBox sr-more">
                    <img width="40px" src="http://cdn.muyutech.com/home1.2/more1.1.png" alt=""/>
                    <p class="moreContentTitle">创建组织</p>
                    <p>支持手动导入，Excel批量导入</p>
                    <p>不同应用环境，自由选择</p>
                </div>
                <div class="moreContentBox sr-more">
                    <img width="40px" src="http://cdn.muyutech.com/home1.2/more2.1.png" alt=""/>
                    <p class="moreContentTitle">二次提醒</p>
                    <p>对未回复通知的人一键发送短信提醒</p>
                    <p>不再担忧收到却不回复</p>
                </div>
                <div class="moreContentBox sr-more">
                    <img width="40px" src="http://cdn.muyutech.com/home1.2/more3.1.png" alt=""/>
                    <p class="moreContentTitle">适应各种应用环境</p>
                    <p>对报名类通知添加回复截止时间</p>
                    <p>超过时间后不再接受回复</p>
                </div>
                <div class="moreContentBox sr-more">
                    <img width="40px" src="http://cdn.muyutech.com/home1.2/more4.1.png" alt=""/>
