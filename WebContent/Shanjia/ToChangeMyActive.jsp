...
<div class="Main-Center"><!-- 左导航栏 -->
	...
	<div class="Main-Content">
		<div class="Card-Head"> <!-- 卡片头 -->
			<h3 class="Card-Head-Title">营销计划信息修改</h3>
		</div>
		<div class="Card-Body" >
			<div class="Center-Form" >
				<s:form class="Center-Form" action ="updateShopActiveInfo" method="post">
					<table>
					...
					<table class="Center-Form">
						<tr>
							<td>计划名称</td>
							<td ><s:textfield name="shopactive.title" value="%{#application.Shopactive.title}" label="计划名称"/></td>
						</tr>
						<tr>
							<td>计划简介</td>
							<td><s:textfield name="shopactive.description" value="%{#application.Shopactive.description}" label="计划简介"/></td>
						</tr>					
						<tr>
							<td></td>
							<td>
