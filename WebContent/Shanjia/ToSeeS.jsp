...
<div class="Main-Center"><!-- 左导航栏 -->
	...
	<div class="Main-Content">
		<div class="Card-Head"> <!-- 卡片头 -->
			<h3 class="Card-Head-Title">查看订单</h3>
		</div>
		<div class="Card-Body" >
			<table class="Card-Body-Table">
				<tr style="background-color:#f5f5f5;">
					...
					<th>是否接受</th>
				<tr>
				<s:iterator value="liaisonrequestList" >
				<tr>
					<td><a href="shouwLiaisondetail.action?liaisonID=<s:property value="liaisonID"/>"><s:property value="departmentdetail"/></a></td>
