...
<div class="Main-Center"><!-- 左导航栏 -->
	...
	<div class="Main-Content">
		<div class="Card-Head"> <!-- 卡片头 -->
			<h3 class="Card-Head-Title">发布营销计划</h3>
		</div>
		<div class="Card-Body" >
			<div class="Center-Form" >
				<s:form class="Center-Form" action ="AddActive" method="post">
					<table class="Card-Body-Table">
						...
						<s:iterator value="shopactiveList" >
							<tr>
								<td><s:property value="title"/></td>
								<td><s:property value="description"/></td>
								<td><s:property value="publisheddate"/></td>
								<td><a href="ToChangeMyShopActive.action?shopactiveID=<s:property value="shopactiveID"/>">修改</a></td>
								<td><a href="delMyShopActive.action?shopactiveID=<s:property value="shopactiveID"/>">删除</a></td>
							</tr>
						</s:iterator>
					</table>				
				</s:form>
