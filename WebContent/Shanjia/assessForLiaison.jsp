...
<div class="Main-Center"><!-- 左导航栏 -->
	...
	<div class="Main-Content">
		...
		<div class="Card-Body" >
		<form action="CreateLiaisonAssess" method="post">
		...
		<table class="Card-Body-Table">		
			...
			<tr>
				<td><s:textfield name="liaisonassess.assess"/></td>
				<td><s:textfield name="liaisonassess.attitude"/></td>
				<td><s:textfield name="liaisonassess.effect"/></td>
			</tr>
				<tr>
					<td></td>
					<td>
