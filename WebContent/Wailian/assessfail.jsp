...
<div id="showdiv">
    ...
    <div class="Center-Show">
			...
			<tr>
				<td><input name="type" type="radio" value=<s:property value="liaisondemandID"/> /></td>
				<td><s:property value="activityname"/></td>
				<td><a href="createIntention.action?businessdemandID=<s:property value="businessdemandID"/>&liaisondemandID=1">有意向</a></td>
			</tr>
			</s:iterator>
       	 </table>
...
<div class="Main-Center"><!-- 左导航栏 -->
	...
	<div class="Main-Content">
		<div class="Card-Head"> <!-- 卡片头 -->
			<h3 class="Card-Head-Title">评价失败！该订单已评价！</h3>
		</div>
		<div class="Card-Body" >
