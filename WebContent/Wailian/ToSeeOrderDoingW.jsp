...
<div id="showdiv1">
    ...
    <div  class="Center-Show"  >
       	 ...
       	 <div style="padding-left: 40%;"><a href="closeLiaisonSeeDoingDetail.action" style="font-size:20px" onclick="closeWindow()">关闭</a></div>
    </div>
    <!-- 按钮 -->
</div>
<!-- 弹窗结束 -->
...
<div class="Main-Center"><!-- 左导航栏 -->
	...
	<div class="Main-Content">
		<div class="Card-Head"> <!-- 卡片头 -->
			<h3 class="Card-Head-Title" style="text-align: center">进行中订单</h3>
		</div>
		<div class="Card-Body" >
		<table class="Card-Body-Table">
			<tr> 
			...
			<tr>
				...
				<td><a href="LiaisonSeeDoingDetail.action?businessdemandID=<s:property value="businessdemandID"/>&liaisondemandID=<s:property value="liaisondemandID"/>">查看详情</a></td>
