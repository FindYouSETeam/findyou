			...
			<div class="Center-Form" >
				<s:form class="Center-Form" action ="updateLiaisonInfo" method="post">
					...
					<table class="Center-Form">
						<tr>
							<td>用户名不可修改</td>
							<td ><s:textfield name="login.account" value="%{#application.liaisonuser.login.account}" readonly="true" style="background-color: #cccccc" label="用户名不可修改"/></td>
						</tr>
						<tr>
							<td>请输入密码</td>
						...
						<tr>
							<td>请输入姓名</td>
							<td><s:textfield name="liaisonuser.name" label="请输入姓名"/></td>
						</tr>
						<tr>
							<td>请输入身份证号码</td>
							<td><s:textfield name="liaisonuser.IDCard" label="请输入身份证号码"/></td>
						</tr>
						<tr>
							<td>请输入电话号码</td>
							<td><s:textfield name="liaisonuser.phone" label="请输入电话号码"/></td>
						</tr>					
						<tr>
							<td></td>
							<td>
