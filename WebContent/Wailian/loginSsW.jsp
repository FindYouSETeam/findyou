...
<div class="Main-Center"><!-- 左导航栏 -->
	...
	<div class="Main-Content">
		<div class="Card-Head"> <!-- 卡片头 -->
			<h3 class="Card-Head-Title" style="text-align: center">现有商家待接订单</h3>
		</div>
		<div class="Card-Body" >
		<table class="Card-Body-Table">
			...
			<td><a href="javascript:void(0);" onclick="showWindow('<s:property value="businessdemandID"/>')">有意向</a></td>
			</tr>
			</s:iterator>
		</table>
		</div>
...
<script type="text/javascript">
    ...
    function closeWindow() {
 	...
 	function want(a,b) 
 	{
	    var pms = 'liaisoncreateIntention.action?businessdemandID=' + document.getElementById("businessdemandID").value
	    +'&liaisondemandID='+b;
		a.href=pms;
	} 
	function read()
