...
<div class="Main-Center"><!-- 左导航栏 -->
	...
	<div class="Main-Content">
		<div class="Card-Head"> <!-- 卡片头 -->
			<h3 class="Card-Head-Title" style="text-align: center">历史发布订单</h3>
		</div>
		<div class="Card-Body" >
		<table class="Card-Body-Table" 	>
			<tr style="background-color:#f5f5f5;">
				<th style="width=10%;">需求周期</th>
				<th>活动名称</th>
				<th>覆盖人数</th>
				<th>最小金额</th>
				<th>最大金额</th>
...
<!-- 				<th>广告位</th> -->
				...
				<th>是否被接受</th>
			<tr>
			<s:iterator value="historyliaisondemandlist" >
			<tr style="border-style: solid;border-bottom-width: 1px">
...
<%-- 			<td style="width: 300px;"><s:property value="activitydetail"/></td> --%>
<%-- 			<td style="width: 91px;"><s:property value="conductdetail"/></td> --%>
