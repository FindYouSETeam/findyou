...
<div class="Main-Center"><!-- 左导航栏 -->
	...
	<div class="Main-Content">
		<div class="Card-Head"> <!-- 卡片头 -->
			<h3 class="Card-Head-Title" style="text-align: center">外联审核</h3>
		</div>
		<div class="Card-Body" >
		...
		<s:iterator value="judgeliaisonlist" >
		<tr>
			<s:hidden name="liaisonuserID" value="ID"/>
			...
			<td><a href="passliaison.action?liaisonuserID=<s:property value="ID"/>&pass=1">接受</a></td>
			<td><a href="passliaison.action?liaisonuserID=<s:property value="ID"/>&pass=0">拒绝</a></td>
		</tr>
		</s:iterator>
		</table>
		</div>
