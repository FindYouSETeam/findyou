...
public class DemandAction {
	...
	public String seehistorybusinessdemand()   //商家查看发布的历史订单
	{
		...
		historybusinessdemandlist=userServ.findBusinessdemandbybussinessID(businessID);
		return "seesuccess";
	}
	public String seehistoryliaisondemand()   //外联查看发布的历史订单
	{
		...
		historyliaisondemandlist=userServ.findliaisondemandbyliaisonID(liaisonID);
		return "seesuccess";
	}
	
	public String Historybussinessdemand()   //外联对商家有意向
	{
		UserService userServ=new UserService();
		Businessdemand businessdemand=userServ.findBusinessdemandbyID(Integer.parseInt(businessdemandID));
